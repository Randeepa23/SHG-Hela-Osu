...
const Products = () => {
  ...
  const products = [
    ...
    },
    {
      ...
      category: "Kwatha",
      description: "Kadahapola Moolaroga Suwaya is a\nliquid Ayurvedic herbal preparation\n(decoction/kwatha-type medicine) used mainly\nfor Moolaroga (piles/hemorrhoids) and related conditions.",
      benefits: ["Piles (Hemorrhoids)", "Constipation", "Digestive complaints"],
      price: 900,
    ...
    {
      id: 5,
      name: "Naturelle Heen Bovitiya 60 Caps",
      category: "Herbal Capsules",
      description: "Heen Bovitiya is widely used as a herbal remedy for fatty liver, hepatitis and other\nliver disorders.",
      benefits: ["Supports Liver Health", "Help Lower Cholesterol and Blood Lipids", "Rich in Antioxidants"],
      price: 790,
    ...
    },
    {
      ...
      benefits: ["Helps with weight loss", "Burning excess body fat", "Supports healthy digestion", "Regulate cholesterol levels"],
      price: 2300,
      image: osethmaImage,
      isExclusive: true,
    },
    {
      ...
      category: "Churna",
      description: "Traditional herbal drink commonly used\nfor relief from cold and flu-related symptoms.\nMainly used as an immune-supporting herbal preparation.",
      benefits: ["Relieve common cold and cough", "Help reduce fever symptoms", "Supports body immune response"],
      price: 400,
      image: sansthaImage,
      isExclusive: false,
    },
    {
      ...
      benefits: ["Blood Formation", "Iron Rich", "Improve energy and stamina", "Nutrient Boost"],
      price: 600,
      image: suensuImage,
      isExclusive: false,
    },
    ...
    },
    {
      ...
      },
      {
        ...
        category: "Herbal Capsules",
        description: "Karapincha Garlic is a herbal formulation combining curry leaf (Karapincha) and garlic in capsule form. Traditionally used to support heart health, blood sugar balance, digestion and immune function.",
        benefits: ["Heart Health", "Blood Sugar Control", "Digestive Support", "Boosts Immune System"],
        price: 650,
      ...
      },
    {
      ...
      {
        id: 5011,
        name: "Amrine Godapara Anti-Dandruff Lotion 50ml 100ml",
        category: "Company",
        description:
      ...
      {
        id: 5014,
        name: "Osunima Horiwila Sandi Thailaya 30ml 60ml 100ml 180ml",
        category: "Oils",
        description:
        ...
        variants: [
         { size: "30ml", price: 300 },
         { size: "60ml", price: 580 },
         { size: "100ml", price: 980 },
         { size: "180ml", price: 1720 }   
      ],
      ...
      {
        id: 5019,
        name: "Rathpiththalepa Kokatath Thailaya 60ml 180ml",
        category: "Oils",
        description:
      ...
      {
        id: 5022,
        name: "Seeduwe Peenas Thailaya 60ml 180ml",
        category: "Oils",
        description:
